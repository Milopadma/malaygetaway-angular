        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-10 md:grid-cols-3 gap-4">
                <div class="p-4 pt-14 border rounded-lg shadow-sm">
                            <h2 class="text-paragraph text-center font-medium mb-10">Promotion Initiatives</h2>
                            <canvas id="chart1"></canvas>
                        </div>
                        <div class="p-4 pt-14 border rounded-lg shadow-sm">
                            <h2 class="text-paragraph text-center font-medium mb-10">Budget Allocation</h2>
                            <canvas id="chart2"></canvas>
                        </div>
                        <div class="p-4 border rounded-lg shadow-sm">
                            <h2 class="text-paragraph text-center font-medium mb-1">Visitor Statistics</h2>
...
export class analytic1 implements OnInit {
  ...
  initCharts(): void {
    ...
    const data1 = {
      labels: ['Petronas KL', 'Genting', 'Aquaria KLCC', 'Bukit Bintang', 'Istana Negara'],
      datasets: [{
    ...
    const data3 = {
      labels: ['Social Media', 'Travel Fairs', 'Partner Collaborations', 'Tourism Packages', 'Advertising Campaigns'],
      datasets: [{
