...
@Component({
  ...
  template: `
    <div
      class="text-paragraph border-2 border-softblack flex flex-row text-softblack text-2xl max-w-full cursor-pointer px-6 py-4 max-md:px-5 hover:bg-softblack hover:text-white transition-all duration-200"
    >
