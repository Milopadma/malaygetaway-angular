...
@Component({
  ...
  template: `
    <div class="fixed inset-0 flex items-center justify-center z-50" (click)="onOutsideClick()">
      ...
      >
        <div class="p-12">
          ...
          <div class="flex justify-between">
            <buttonbordered label="{{ button1 }}"></buttonbordered>
            <buttonbordered label="{{ button2 }}" (click)="onSecondButtonClick()"></buttonbordered>
          </div>
        </div>
      </div>
    </div>
