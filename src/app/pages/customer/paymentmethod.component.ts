      ...
      >
        ...
        <div class="bg-white p-6 rounded-lg">
          ...
          <div class="flex justify-center gap-4 mb-6">
            <button
              class="group py-1 px-10 border font-bold rounded-lg flex flex-col items-center text-softblack"
            ...
            >
              <div class="w-12 h-12 mb-2 flex justify-center items-center">
                <img
                  src="https://www.freepnglogos.com/uploads/mastercard-png/mastercard-logo-transparent-png-stickpng-10.png"
                  alt="Credit Card"
                  class="h-10"
                />
              </div>
            ...
            <button
              class="group py-1 px-10 font-bold border rounded-lg flex flex-col items-center text-softblack"
            ...
            >
              <div class="w-20 h-12 mb-2 flex justify-center items-center">
                <img
                  src="https://www.pngplay.com/wp-content/uploads/8/Paypal-Transparent-Image.png"
                  alt="PayPal"
                  class="h-20"
                />
              </div>
          ...
          <form *ngIf="selectedMethod === 'paypal'" class="flex flex-col gap-4">
            <div class="text-center mt-4">
              ...
              <button
                (click)="navButton3()"
                class="text-white bg-softblack hover:bg-fadedgray focus:ring-4 focus:outline-none focus:ring-blue-300 mb-2 font-medium rounded-lg text-small px-8 py-2.5 text-center"
              >
                Proceed with PayPal
              </button>
            </div>
          ...
          >
            <div class="mb-1">
              ...
              <input
                type="text"
                id="cardNumber"
                placeholder="1234 5678 9097 1287"
                name="cardNumber"
                class="bg-white border border-fadedgray text-softblack text-small rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
...
export class CustomerPaymentMethodComponent {
  ...
  navButton2() {
    this.router.navigate(['customer/paymentsuccess/2332']);
  }
  navButton3() {
