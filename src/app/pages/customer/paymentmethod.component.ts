    ...
    <section>
      ...
      >
        ...
        <div class="bg-white p-6 rounded-lg">
          ...
          <p class="text-small text-softblack mb-10">
            Choose PayPal as the Payment Method
          </p>
          <div class="w-full h-12 mb-10 flex justify-center items-center">
            <img
              src="https://logos-download.com/wp-content/uploads/2016/03/PayPal_Logo_2007.png"
              alt="PayPal"
              class="h-20"
            />
          </div>
  ...
  ngAfterViewInit(): void {
    if (isPlatformBrowser(this.platformId)) {
      this.loadPayPalScript().then(() => {
        const productPrice =
          this.productService.getSelectedProductPrice() || '0.01';
        paypal
          .Buttons({
  ...
  loadPayPalScript(): Promise<void> {
    return new Promise<void>((resolve, reject) => {
      if (typeof window !== 'undefined' && typeof document !== 'undefined') {
        ...
        scriptElement.src =
          'https://www.paypal.com/sdk/js?client-id=AalFHw36Pr_cNCwcoGfJc4zlBYjVnH_9Ew4UFZieMn8Z4AoO2orOS9uJdeSSMbUXiWy7BG6sLOEz9i7m';
