                    ...
                    <form action="#" method="POST">
                        ...
                        <div class="grid gap-6 mb-1 lg:grid-cols-2">
                            <div>
                                ...
                                <input type="text" id="city" name="city" class="bg-white border border-fadedgray text-softblack text-small rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                            </div>
                            <div>
                                <label for="state" class="block mb-2 text-small font-medium text-softblack">State</label>
                                <input type="text" id="state" name="state" class="bg-white border border-fadedgray text-softblack text-small rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                            </div>
                        </div>
                        <div class="grid gap-6 mb-5 lg:grid-cols-2">
                            <div>
                                ...
                                <input type="text" id="country" name="country" class="bg-white border border-fadedgray text-softblack text-small rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                            </div>
                            <div>
                                <label for="zip" class="block mb-2 text-small font-medium text-softblack">ZIP / Postal Code</label>
                                <input type="text" id="zip" name="zip" class="bg-white border border-fadedgray text-softblack text-small rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" (input)="formatZipCode($event)" required>
                            </div>
                        </div>
...
export class CustomerPersonalDetailComponent  {
    ...
    navButton2() {
        this.router.navigate(['billingaddress/:id']);
    }
